...
#define P0g _p[12]
#define fCag _p[13]
#define lambda1 _p[14]
#define lambda2 _p[15]
#define threshold1 _p[16]
#define threshold2 _p[17]
#define initW _p[18]
#define fmax _p[19]
#define fmin _p[20]
#define thr_rp _p[21]
#define facfactor _p[22]
#define f _p[23]
#define tauF _p[24]
#define d1 _p[25]
#define tauD1 _p[26]
...
#define t0 _p[51]
#define ICan _p[52]
#define Afactor _p[53]
#define dW_gaba _p[54]
#define rp _p[55]
#define tsyn _p[56]
#define fa _p[57]
#define Dr_nmda _p[58]
#define Dr_gaba _p[59]
#define Dcapoolcon _p[60]
#define DW _p[61]
#define _g _p[62]
#define _tsav _p[63]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 64, 6);
 	hoc_register_cvode(_mechtype, _ode_count, _ode_map, _ode_spec, _ode_matsol);
 	hoc_register_tolerance(_mechtype, _hoc_state_tol, &_atollist);
 pnt_receive[_mechtype] = _net_receive;
 pnt_receive_size[_mechtype] = 1;
 	hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 interD2pyrD_STFD /storage/hpc/data/latimerb/100Cell_LA/x86_64/interD2pyrD_STFD_new.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  release();
 if(error){fprintf(stderr,"at line 181 in file interD2pyrD_STFD_new.mod:\n	 \n"); nrn_complain(_p); abort_run(error);}
